...
import 'package:adicto_school/src/pages/classes/presentation/classes_screen.dart';
import 'package:adicto_school/src/pages/home/presentation/home_screen.dart';
...
import 'package:adicto_school/src/pages/subscribers/presentation/subscribers_screen.dart';
import 'package:adicto_school/src/pages/subscription_plan/presentation/subscription_plan_screen.dart';
...
class _MainScreenState extends State<MainScreen> {
  // Local state removed, using widget.selectedIndex
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          // Screen Title below AppBar (hidden for Classes and Dashboard screens - they have their own titles)
          if (widget.selectedIndex != 1 && widget.selectedIndex != 0)
            Padding(
              padding: const EdgeInsets.fromLTRB(16, 8, 16, 12),
              child: Align(
                alignment: Alignment.centerLeft,
                child: Text(
                  _screenTitles[widget.selectedIndex],
                  style: GoogleFonts.outfit(
                    fontSize: 20,
                    fontWeight: FontWeight.bold,
                    color: const Color(0xFF333333),
